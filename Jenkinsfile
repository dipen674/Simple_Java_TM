            ...
            steps {
                withCredentials([
                    ...
                    ssh -i "${ANSIBLE_KEY}" ${SSH_USERNAME}@${ANSIBLE_HOST} '
                        ...
                        rm -rf /home/vagrant/{java_app_required_files,java_app_docker}
                        mkdir -p /home/vagrant/java_app_required_files
                        
                        echo "=== Downloading Application Files ==="
                        cd /home/vagrant
                        git clone --single-branch --branch docker https://github.com/dipen674/Simple_Java_TM.git java_app_docker
                        cp java_app_docker/{Dockerfile,docker-compose.yml,init.sql} java_app_required_files/
                        rm -rf java_app_docker
